...
import sty from "./PlasmicButton.module.css"; // plasmic-import: kAPW_62_PI7/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: lhSCFW6snMj/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: YGJVxtt_h8v/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__rZ0Lt)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__l216X)}
                role={"img"}
              />
            ),
